const catalogProducts = [
  {
    ...
    price: 1690,
    category: "Cocina",
    coverImage: "productos/cubiertos/3A33C539-5DFB-4FF7-90EB-D8B054A42139.JPG.jpeg",
    variant: "Silicona alimentaria con mango efecto madera",
    badge: "Más elegido",
    shortDescription: "Piezas esenciales para cocinar, servir y mantener todo a mano.",
    description:
    ...
    highlights: ["Soporte incluido", "Silicona resistente al calor", "Cuida superficies antiadherentes"],
    images: [
  ...
  {
    id: "bateria-rosa-desmontable",
    name: "Batería rosa desmontable 17 piezas",
    price: 4290,
    category: "Cocina",
    ...
    badge: "Nuevo",
    shortDescription: "Set apilable para cocinar cómodo, ahorrar espacio y lucir una cocina más suave.",
    description:
  ...
  {
    id: "ollas-blancas-desmontables",
    name: "Set de ollas desmontables marfil",
    price: 3890,
    category: "Cocina",
    coverImage: "productos/ollas blancas/30048358-3FE8-496D-A25F-AE2DCCC5D808.JPG.jpeg",
    variant: "Set compacto de 5 piezas",
    badge: "Favorito",
    shortDescription: "Ollas apilables en tono marfil para una cocina luminosa, práctica y ordenada.",
    description:
    ...
    highlights: ["Tono neutro elegante", "Ideal para espacios chicos", "Presentación cuidada"],
    images: [
  ...
  {
    id: "sarten-cuatro-cavidades",
    name: "Sartén de 4 cavidades",
    price: 1290,
    category: "Cocina",
    coverImage: "productos/sarten forma/72FCDAA3-BA35-4427-B310-90C4D2950F8F.JPG.jpeg",
    variant: "Antiadherente efecto piedra",
    badge: "Desayunos",
    shortDescription: "Ideal para huevos, pancakes y porciones parejas sin ensuciar de más.",
    description:
    ...
    highlights: ["Cuatro porciones a la vez", "Fácil de limpiar", "Mango cómodo"],
    images: [
  ...
  {
    id: "sarten-grill-cuadrado",
    name: "Sartén grill cuadrado",
    price: 1490,
    category: "Cocina",
    coverImage: "productos/sarten rallado/187DCD2E-F030-4513-883D-33D1F9F65C8E.JPG.jpeg",
    variant: "Base apta para gas e inducción",
    badge: "Top cocina",
    shortDescription: "Grill compacto para carnes, vegetales y marcas doradas con terminación prolija.",
    description:
    ...
    highlights: ["Apto para inducción", "Diseño cuadrado", "Acabado tipo piedra"],
    images: [
      ...
      "productos/sarten rallado/1E51D325-DE98-4D60-A749-92263929805D.JPG (1).jpeg",
